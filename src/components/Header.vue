<template>
  	<div class="o-header">
        ...
        <router-link v-if="heading === 'photogram'" :to="{ name: 'search' }" tag="div" class="o-header__search  a-search" :class="{ 'is-active': isSearchActive }">
            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                viewBox="0 0 118.783 118.783" style="enable-background:new 0 0 118.783 118.783;" xml:space="preserve">
            <g>
                <path class="cls-1" d="M115.97,101.597L88.661,74.286c4.64-7.387,7.333-16.118,7.333-25.488c0-26.509-21.49-47.996-47.998-47.996
        ...
        <router-link v-if="heading !== 'Terms and Conditions'" :to="{ name: 'my-notifications' }" tag="div" class="o-header__bulb  a-bulb" :class="{ 'is-active': isNotificationActive }">
            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
